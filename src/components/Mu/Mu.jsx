...
function Mu() {
  return (
    <section className={styles.container} id='mu'>
        <h2 className={styles.title}> Mother’s Union Leadership </h2>
        ...
        <div className={styles.aboutContainer}>
            ...
            <div className={styles.aboutDescription}>
                <p>The Mother’s Union is the oganization that brings together women of the Anglican denomination 
                 ...
                 <p> The Mother’s Union was founded in 1876 by Mary Sumner, a member of Church of England
                         ...
                         and to be trained in motherhood. In Kenya, the movement started in 1918 by settler women. </p>
                 <p> At St. James Cathedral, Mother’s Union is strong in fellowships, family education,
                             and income generating projects such as tailoring school and tents and seats for hire. </p>
